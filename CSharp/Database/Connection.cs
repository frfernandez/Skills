...
namespace Database
{
    public class Connection
    {
        ...
        public ConnectionEnum Open()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show(String.Concat("Erro ao tentar abrir a conexão com o banco de dados.\nMensagem original:\n", exc.Message), "Connection", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
        ...
        public DataSet DataSetDb(IDbCommand Command, string CommadType)
        {
            ...
            {
                MessageBox.Show(String.Concat("Erro ao tentar preencher o conjunto de dados no adaptador.\nMensagem original:\n", exc.Message), "Connection", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                Adapter = null;
